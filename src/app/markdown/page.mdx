...
# Titles, level 1
This is a **bold text**, _italic text_, and _**bold italic text**_ (`_` and `*` are interchangable for these purposes)…. ~~Don't read this text~~

And this is `inline computer` text

## Title 2: Unordered and Ordered Lists
...
### Title 3: Blockquotes and Colors
This is what they said:
> This is quoted content that may be wide and too wide to contain in the area.
...
| Centered | Left align |  Right |
| :------: | :--------- | -----: |
|  Cell 1  | Cell 2     | Cell 3 |
|    4     | 5          | Cell 6 |
|  Cell 5  | Cell 8     |      9 |

###### Title 6: Footnotes, doc links, and images

Here is a simple footnote[^1].

A footnote can also have multiple lines[^2].

Here is a interdoc [reference](#title-4-checkboxes)

[^1]: My reference.
[^2]: To add line breaks within a footnote, prefix new lines with 2 spaces.
  This is a second line.

Look at the image! ![Image alt](https://avatar.iran.liara.run/public/boy?username=a)
